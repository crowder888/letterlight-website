  ...
  return (
    <main className="flex flex-col">
      ...
      <section className="relative min-h-screen flex items-center justify-center bg-[#1C1C1E] overflow-hidden">
        {/* Hero crossfade videos — revert: replace <HeroVideo /> with <Image src="/hero.png" fill className="object-cover object-center" priority sizes="100vw" alt="Illuminated marquee letters at a wedding reception" /> */}
        <HeroVideo />
